...
<html lang="en">
  ...
  <title>Web Pembayaran Tagihan Kos</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-info">
              <div class="card-header"><h5>WELCOME MY KOST</h4></div>

              <div class="card-body">
                <!-- cek login user -->
               <form action="verif_loginpenghuni.php" method="post">
               ...
               <div class="form-group">
                ...
                <hr>
                  ...
                  <div class="text-center">
                    <a class="small" href="login_admin.php">Masuk Sebagai Admin</a>
                  </div>  
