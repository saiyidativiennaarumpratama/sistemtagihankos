                         ...
                         <tbody>
                           ...
                           <?php
                              ...
                              $query = "SELECT tagihan.id_tagihan, penghuni.id_penghuni, penghuni.nama, kamar.id_kamar , kamar.nominal, penghuni.status 
                                ...
                                WHERE penghuni.id_tagihan=tagihan.id_tagihan AND status='belumbayar' ";
                        ...
                        <tr>  
                          ...
                          <td>
                            ...
                            <br>
                              ...
                              <input type="submit" class="btn btn-success" value="&#10004;" name="" onClick="return confirm('Apakah Penghuni Sudah Membayar Kos?')"></label>
