        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><a href="petugas.php">Data Admin</a></div>
              <div class="breadcrumb-item text-primary">Tambah Admin</div>
            </div>
          </div>
          <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body bg-primary">
                    ...
                    <form class="wizard-content mt-2" method="post" action="proses_tambahpengguna.php">
                      <div class="wizard-pane">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4 col-md-6 text-right">
                            <button type="submit" class="btn btn-icon icon-right btn-primary">TAMBAH ADMIN<i class="fas fa-arrow-right"></i></button>
                          </div>
                        </div>
                      </div>
                    </form>
